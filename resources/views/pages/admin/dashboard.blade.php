        ...
        <div class="container-fluid p-0">
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="mt-1 mb-3">{{ App\Models\Link::count() }}</h1>
                                        <div class="mb-0">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="mt-1 mb-3">{{ App\Models\User::where('user_type', 'user')->count() }}
                                        </h1>
                                        <div class="mb-0">
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="mt-1 mb-3">{{ App\Models\Domain::count() }}</h1>
                                        <div class="mb-0">
                                            {{-- <span class="text-success">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="mt-1 mb-3">{{ App\Models\User::where('user_type', 'admin')->count() }}
                                        </h1>
                                        <div class="mb-0">
                                            {{-- <span class="text-danger">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-xxl-9 d-flex order-3 order-xxl-2">
                    <div class="card flex-fill w-100">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Clicks around the world</h5>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 col-xxl-3 d-flex">
                    <div class="card flex-fill w-100">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Monthly Clicks</h5>
                        </div>
...
@section('script')
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var data = <?php echo json_encode($monthlyStats); ?>;
            var months = [];
            var clicks = [];
            data.forEach(element => {
                months.push(element['month']);
                clicks.push(element['count']);
            });
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Bar chart
            var data = <?php echo json_encode($monthlyUsers); ?>;
            var months = [];
            var usersNumber = [];
            data.forEach(element => {
                months.push(element['month']);
                usersNumber.push(element['count']);
            });
